#!/usr/bin/env python3
"""Run ONE problem of bbq through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one bbq problem via TrustedRouter")
